...
echo ===================================================================
echo Running Security Static Analysis and Unit Tests against build.id=%BUILD_ID%
echo ===================================================================

echo **1/3** Execute Static Analysis: OWASP Top 10-2017
call mvn jtest:jtest -Djtest.publish=true -Djtest.config="jtest.dtp://OWASP Top 10-2017" -Dmaven.test.skip=true -Dmaven.test.failure.ignore=true -Dproperty.dtp.project=%DTP_PROJECT% -Djtest.showsettings=true -Djtest.report=%REPORT_DIR%\jtest-sa -Dproperty.console.verbosity.level=high -Dproperty.build.id=%BUILD_ID% -Djacoco.skip=true > %LOG_DIR%\jtest-sa-%RUN_TIME%.log 2>&1
...
echo =================================================================
echo Finished Security Static Analysis and Unit Testing of build.id=%BUILD_ID%
echo =================================================================
